...
package dev.mutwakil.androidide.treesitter;

import static com.google.common.truth.Truth.assertThat;
import static dev.mutwakil.androidide.treesitter.ResourceUtils.readResource;

import android.text.TextUtils;
import dev.mutwakil.androidide.treesitter.aidl.TSLanguageAidl;
...
public class ParserTest extends TreeSitterTest {
  ...
  public void testLogGrammar_logcatLine() {
    try (final var parser = TSParser.create()) {
      ...
      final var source = "06-16 17:32:54.289 19154 19154 W ziparchive: Unable to open '/data/app/~~S0ZGwshlag_3SKvS2AUm9g==/dev.mutwakil.androidide.logsender.sample-2mbpM5fpkBwx7otcNLWYNA==/base.dm': No such file or directory";
  ...
  public void testLogGrammar_ideLogLine() {
    try (final var parser = TSParser.create()) {
      ...
      final var source = "2024-03-16 19:15:30,267 DEBUG [ForkJoinPool.commonPool-worker-9] JdkUtils: Found java.home=/data/data/dev.mutwakil.androidide/files/usr/opt/openjdk-17.0";
  ...
  public void testAIDLGrammar_interfaceDecl() {
    try (final var parser = TSParser.create()) {
      ...
      try (final var tree = parser.parseString(source)) {
        ...
        assertThat(packages).containsExactly("dev.mutwakil.androidide.treesitter.test");
