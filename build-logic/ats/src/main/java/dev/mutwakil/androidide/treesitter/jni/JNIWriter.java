...
package dev.mutwakil.androidide.treesitter.jni;
...
public class JNIWriter {
  ...
  public JNIWriterResult generate(TypeElement type) {
    ...
    // e.g. for "dev.mutwakil.androidide.treesitter.TreeSitter.Native
    // this will be "dev/mutwakil/androidide/treesitter/TreeSitter$Native
