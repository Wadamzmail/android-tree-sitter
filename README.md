...
<a href="https://github.dev/mutwakil/AndroidIDE"><img src="https://androidide.com/github/img/androidide.php?part&for-the-badge"/></a><br><br>
...
the [`DynamicModulePlugin`](https://github.com/AndroidIDEOfficial/android-tree-sitter/tree/dev/build-logic/ats/src/main/java/dev/mutwakil/androidide/treesitter/DynamicModulePlugin.kt).
...
are [other Gradle plugins](https://github.com/AndroidIDEOfficial/android-tree-sitter/tree/dev/build-logic/ats/src/main/java/dev/mutwakil/androidide/treesitter)
...
For examples, see
the [tests](https://github.com/AndroidIDEOfficial/android-tree-sitter/tree/dev/android-tree-sitter/src/test/java/dev/mutwakil/androidide/treesitter).
