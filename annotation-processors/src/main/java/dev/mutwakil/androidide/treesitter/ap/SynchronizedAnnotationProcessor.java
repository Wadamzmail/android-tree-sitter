...
package dev.mutwakil.androidide.treesitter.ap;
 ...
 * @author Akash Yadav
 */
@SupportedAnnotationTypes(value = {"dev.mutwakil.androidide.treesitter.annotations.Synchronized",
  "dev.mutwakil.androidide.treesitter.annotations.NotSynchronized"})
